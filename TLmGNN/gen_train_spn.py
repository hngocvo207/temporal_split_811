...
dump_dir = f"gen_spn_seq/data_train_spn"
...
if cfg_ds == "Dataset":
    ...
    train_valid_df = pd.read_csv(
        "gen_spn_seq/trans_sentence/train.tsv", encoding="utf-8", header=0, sep="\t"
    )
    ...
    test_df = pd.read_csv(
        "gen_spn_seq/trans_sentence/dev.tsv", encoding="utf-8", header=0, sep="\t"
    )
